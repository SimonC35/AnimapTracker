...
Ce projet sert de bac à sable pour expérimenter des composants (carte, requêtes API, UI) de manière isolée, sans risquer de casser l'application principale.
